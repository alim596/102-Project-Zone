...
public class ZonesRecViewAdapter extends RecyclerView.Adapter<ZonesRecViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.quota.setText(zones.get(position).getName());
        holder.date.setText(zones.get(position).getName());
        holder.details.setText(zones.get(position).getName());
        //holder.image.setImageDrawable(zones.get(position).getImageUrl());
    }
